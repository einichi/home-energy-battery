...
export function AutomationPage() {
  ...
  return (
    <main className="page automation-page">
      ...
      {error ? <div className="status-banner" data-severity="critical"><T text={"Automation: "} />{formatDateTimesInText(error)}</div> : null}
