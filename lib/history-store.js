...
function emptyRollupState(startMs, resolution) {
  return {
    ...
    fuelCell: { operatingSeconds: 0, startCount: 0, states: {}, qualities: {}, lastState: null, sourceHosts: {} },
    guardTriggerCount: 0,
    rateYenPerKwh: null,
    rateLabel: null,
  };
...
function addRollupSample(state, sample) {
  state.fuelCell ??= { operatingSeconds: 0, startCount: 0, states: {}, qualities: {}, lastState: null, sourceHosts: {} };
