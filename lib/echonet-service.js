...
async function executeEchonetCommand(command, args = {}, positional = [], client = null) {
...
async function createEchonetCommandAdapter(options = {}) {
  const client = options.client ?? makeClient(options);
  let initialization = null;
  let closed = false;
  return {
    async execute(command, args = {}, positional = []) {
