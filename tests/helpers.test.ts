...
const precedingHourForecast: Record<string, any> = {
  hours: [
...
function batteryLearningRollup(day: any, kind: any, {
...
function chronologicalSlot(hour: any, band: any, netKwh: any = 0, highSolarNetKwh: any = netKwh): any {
