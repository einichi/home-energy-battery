...
assert.ok(unavailablePrimary.errors.some((error: any) => error.host === "10.250.0.30" && error.epc === "0xC5"));
...
assert.ok(simulator.calls.some((call: any) => call.command === "charge" && call.args["target-wh"] === 1096));
